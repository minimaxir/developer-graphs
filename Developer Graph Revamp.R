...
font_axis <- "Avenir Next Condensed Medium"
themecolor <- "#FAFAFA"
themebg <- "#222222"
...
title = element_text(family=font_axis,size=8))                                     
}

df <- data.frame(lang=c("Java","PHP","C#","Android","JavaScript","Rails","Python","iOS",".net","C++"),
perc=c(0.2226,0.1153,0.1074,0.0994,0.0923,0.0830,0.0829,0.0753,0.0722,0.0496))
...
labs(y = toupper("Percent Among Top 10 Searches"), title=toupper("Top 10 Most In Demand Developer Skills of 2013"))
...
theme_chalk() +
theme(axis.title.x = element_text(family=font_axis), axis.title.y = element_blank(), axis.ticks.y = element_blank(),axis.text.y= element_blank()) +
geom_text(label=df$lang, hjust=-0.25, color=themecolor, family=font, size=2) +
labs(y = toupper("Percent Among Top 10 Searches"), title=toupper("Top 10 Most In Demand Developer Skills of 2013"))
...
geom_text(label=perc_text, hjust=1.5, color=themecolor, family=font, size=2) +
labs(title=toupper("Top 10 Most In Demand Developer Skills of 2013"))
